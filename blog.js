...
const ACCOUNT = { //账号相关，安全性更高
  ...
  "user" : "admin", //博客后台用户名
  "password" : "w@bjt@m!", //博客后台密码
  "third_token" : "cfblog", //开放token，当前仅允许访问/admin/search.xml，/admin/sitemap.xml时可用，在cfblog_token的头信息中传递
  "cacheZoneId":"ccc43e65ebe47786e5888503ab233132",//区域 ID
  "cacheToken":"JJO1ffF9caFICnxtiVTP-S__bOp9dChTQXDf3rPy",//API token
...
const OPT = { //网站配置
  ...
  /*--前台参数--*/
  "siteDomain" : "blog.weizhen.xyz",// 域名(不带https 也不带/)
  "siteName" : "Mr.wei-Blog",//博客名称
  "siteDescription":"明确的目标是前进的动力" ,//博客描述
  "keyWords":"cloudflare,KV,workers,blog",//关键字
  "logo":"https://pic.imgdb.cn/item/611ddf5f4907e2d39c239a10.png",//JustNews主题的logo
  ...
  "otherCodeD":``,//
  "otherCodeE":``,//
  "copyRight" :`Powered by <a href="https://github.com/vip-weizhen">Mr.wei</a> & 联系我: vip.weizhen@gmail.com`,//自定义版权信息,建议保留大公无私的 Coudflare 和 作者 的链接
  "robots":`User-agent: *
Disallow: /admin`,//robots.txt设置
  ...
  "editor_page_scripts": `
    ...
    if($('#img').val()=="")$('#img').val('https://pic.imgdb.cn/item/611dcb864907e2d39cf67f6b.jpg');
    //默认时间设置为当前时间
...
async function handle_favicon(request){
  ...
  想要自定义，或者用指定的ico，可将此请求置为404，并在codeBeforHead中自行添加类似代码：
    <link rel="icon" type="image/x-icon" href="https://pic.imgdb.cn/item/611de77d4907e2d39c36ac30.png" />
    <link rel="Shortcut Icon" href="https://pic.imgdb.cn/item/611de77d4907e2d39c36ac30.png">
  */
  /*
